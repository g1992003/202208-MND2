									...
									?>
											<tr>
												<td style="text-align: center; vertical-align: middle;" width="20%" id="td_img">
													<div class="btn-group">
														<button style="margin:2px 5px;" class="btn btn-xs btn-info" onclick="javascript:location.href='depart.php?id=<?php echo (int) $v[$id_name]; ?>';">相關資訊</button>
														<button data-toggle="dropdown" class="btn btn-xs btn-info dropdown-toggle">其他資訊 <span class="caret"></span></button>
														...
														<button style="margin:2px 5px;" class="btn btn-xs btn-success" onclick="javascript:location.href='depart_password.php?id=<?php echo (int) $v[$id_name]; ?>';">密碼修改</button>
													</div>
												</td>
