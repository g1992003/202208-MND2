				...
				<div class="col-xs-12">
					<div class="widget-box">
						...
						<div class="widget-content nopadding">
							<form class="form-horizontal" method="post" action="../control/doupdate.php?<?php echo 'db=' . $db_set . '&id_name=' . $id_set . '&id=' . $_SESSION["dominator_id"]; ?>" name="pw_chang" id="pw_chang">
								...
								<div class="form-group">
									...
									<div class="col-sm-9 col-md-9 col-lg-10">
										...
										<input type="hidden" name="<?php echo $password_set; ?>" id="u_password">
									</div>
								</div>
								<div class="form-group">
		...
		function check_pw() {
			$.ajax({
				...
				data: {
					...
					"password": $("#pw").val(),
					"type": <?php echo $_SESSION["dominator_main"]; ?>
				},
