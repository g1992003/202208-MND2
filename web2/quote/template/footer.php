...
<footer class="move_top">
    <ul class="footer">
        ...
        <li class="logInShow">
            ...
            <ul>
                <li>
                    <a href="regulation.php">行政規則<br>REGULATION</a>
                </li>
                <li>
                    <a href="policy.php">一令到位<br>ORDER</a>
                </li>
                <?php foreach ($sys_link_title as $k => $v) { ?>
                    <li>
                        <a <?php echo ($v["l_type"] == 1) ? 'href="' . $v["l_url"] . '" target="_blank"' : 'href="edi_system.php?id=' . $k . '"'; ?>>
        ...
        <li>
            ...
            <ul>
                <?php foreach ($link_title as $k => $v) { ?>
                    <li>
                        <a <?php echo ($v["l_type"] == 1) ? 'href="' . $v["l_url"] . '" target="_blank"' : 'href="edi_link.php?id=' . $k . '"'; ?>>
                            <?php echo $v["l_title"] . "<br>" . $v["l_title_2"]; ?>
                        </a>
                    </li>
                <?php } ?>
